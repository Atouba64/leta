# Call Scripts & Emails: Granite Telecommunications

## 1. LinkedIn Connection Request (Targeting: Director of Partner Networks)
**Subject/Note:** Local IT field coverage in Georgia
"Hi [Name], I see you manage vendor networks for Granite Telecommunications. Leta is an IT field service platform based in GA. We provide a single, SLA-guaranteed tech bench for the entire state so you don't have to juggle multiple 1099s. Would love to connect and share how we support MSPs/NSPs."
...
I know Granite Telecommunications handles massive deployment and support volumes. One of the biggest challenges for NSPs is maintaining reliable, high-quality "hands and eyes" in specific regional markets without expanding W2 headcount. 
