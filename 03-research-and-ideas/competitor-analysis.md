...
| Moat lever | Evidence to collect |
|------------|---------------------|
| **First-time fix rate** | Overwatch-assisted jobs vs baseline |
| **Partner retention** | Dashboard tier attach rate |
| **Tech NPS** | Payout speed + job quality |
| **Unit economics** | Gross margin after insurance + processing |

## Open questions

- Which deals are won on **price** vs **visibility** vs **speed**?  
- Where will partners insist on **white-label** vs **co-brand**?
