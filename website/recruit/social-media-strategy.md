...
**Budget posture:** Bootstrap / pilot — prioritize **organic + phone + hyper-local paid** over broad brand campaigns.
...
3. **Two-step intake** — text or call (30 sec) → full application (8 min) → human screen.
...
|---------|------|----------|-----|
| **SMS / phone** | Free | All personas; fastest trust | Pre-filled “join crew” message |
...
| **Facebook/IG paid local** | $5–15/day/geo | Scale what organic proves | “Text or call” |
...
|------|-----|-----|-----|-----|
| 1 | Reel: “POV fix Wi‑Fi on site” (A) | Story poll: “Got a car + phone?” | FB group post (gig) | SMS status: “3 slots screening” |
...
| 4 | Reel: referral tease | “Apply in 30 sec” text CTA | Recap: “Now live in [city]” | Boost best Reel $25 |
...
Log source: `text` | `call` | `web` | `app` | `referral` in spreadsheet.

---

## Implementation checklist (already on site)

- [x] [technicians.html](../technicians.html) — crew positioning + text/call + follow section
...
- [x] [google-voice-templates.txt](./google-voice-templates.txt) — operator reply templates
...
- [ ] Record voicemail greeting on business line
