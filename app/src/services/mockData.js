...
export const DEMO_TECH_OFFERS = [
  ...
  },
  {
    ...
    payout: '$210',
    sla: 'NBD',
    skills: ['Cabling', 'Networking'],
    urgent: true,
  },
  {
    id: 'offer-503',
    title: 'Printer jam — law office',
    distanceMi: 8.1,
    payout: '$95',
    sla: '4 hr',
    skills: ['Printers'],
  ...
  {
    id: 'offer-504',
    title: 'Cradlepoint install — retail',
    distanceMi: 22.4,
    payout: '$185',
    sla: 'NBD',
